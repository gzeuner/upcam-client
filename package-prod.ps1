...
$javaFiles = @(
  ...
  @{ Source = Join-Path $repoRoot 'src\main\resources\application.properties'; Target = 'application.properties' },
  @{ Source = Join-Path $repoRoot 'src\main\resources\application.local.properties.example'; Target = 'application.local.properties.example' },
  @{ Source = Join-Path $repoRoot 'src\main\resources\upcamclient.properties'; Target = 'upcamclient.properties' },
...
- Copy application.local.properties.example to application.local.properties and set credentials on target host.
- Start Java with upcamclient.cmd/sh (prefers application.local.properties, then application.properties).
